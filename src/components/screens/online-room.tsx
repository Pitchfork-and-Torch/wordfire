    ...
    <div className="relative mx-auto flex min-h-dvh w-full max-w-2xl flex-col overflow-hidden px-5 pt-5 sm:px-6">
            ...
            {camp.joined ? (
              <>
                ...
                {camp.connectedCount < linkLabel
                  ...
                  : ""}
                {camp.throughTheWall ? " · Through the wall" : ""}
              </>
            ) : (
              <>
      ...
      {camp.connectionIssues.length > 0 ? (
        ...
        >
          ...
          <p>
            This network is blocking even the relay. Try another network, or
                    ...
                    {isSelf
                      ...
                      : peer
                        ? peer.connectionState === "connected"
                          ? peer.candidateType === "relay"
                            ? peer.rttMs != null
                              ? `Through the wall · ${Math.round(peer.rttMs)}ms`
                              : "Through the wall"
                            : peer.rttMs != null
