...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      ...
      { rel: "apple-touch-icon", href: "/apple-touch-icon.png?v=1.0.0", sizes: "180x180" },
      { rel: "apple-touch-icon", href: "/icons/icon-512.png?v=1.0.0", sizes: "512x512" },
    ],
  }),
  ...
  return (
    <html lang="en" data-theme="night" suppressHydrationWarning>
      ...
      <body className="min-h-dvh bg-bg text-fg antialiased">
        ...
        <script defer src="https://hits.jonbailey.xyz/c.js" data-site="wordfire"></script>
        <Scripts />
      </body>
    </html>
  );
