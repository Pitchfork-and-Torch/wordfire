...
const OG_IMAGE = `${SITE_URL}/og.jpg?v=1.1.1`;
  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Wordfire — pass-and-play campfire storytelling. One word at a time, shared imagination. Local circle or remote WebRTC rooms. Stories stay on-device.",
      },
